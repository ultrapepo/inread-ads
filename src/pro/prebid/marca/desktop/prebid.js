...
function getLazyLoad(s, ct) {
  if (s === 'portada')
    return ['re', 'rf', 'rg', 'c990x50_320x53d', 'ri'];
...
HTTP_X_GEO_ISO_CODE;
                ...
                echo <<<HTTP_X_GEO_ISO_CODE
function getLazyLoad(s, ct) {
  return ['b300x100b', 'b300x100c', 'b300x100d', 'c990x50_320x53', 'c990x50_320x53b', 'c990x50_320x53c', 'c990x50_320x53d', 'mb', 'r-nata', 'r-nata-prm-snw', 'r-natb', 'rb', 'rb-prm-snw', 'rc', 'rc-prm-snw', 'rd', 're', 'rf', 'rg', 'ri'];
}
